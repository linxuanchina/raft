...
{
    public static Pagination New(int indexFrom, int pageIndex, int pageSize) => new(indexFrom, pageIndex, pageSize);
    ...
    private Pagination(int pageIndex, int pageSize, int indexFrom, int totalCount) : this(indexFrom, pageIndex,
        pageSize)
    {
    ...
    public Pagination FillNew(int totalCount) => new(PageIndex, PageSize, IndexFrom, totalCount);
